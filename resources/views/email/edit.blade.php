                ...
                <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Email</h3>
                            <p class="mt-1 text-sm text-gray-500">Update the emai's information.</p>
                        </div>
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <form class="space-y-6" action="/updateEmail" method="POST">
                                @csrf
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            ...
                                            <input type="email" name="email" id="title"  value="{{$email->email}}"
